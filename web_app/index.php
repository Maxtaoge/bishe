...
?>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="fh5co-offcanvass">
		...
		<h1 class="fh5co-logo"><a class="navbar-brand" href="index.php">TGMMOVIE</a></h1>
		<ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<a class="navbar-brand" href="index.php">TGMMOVIE</a>		
				</div>
			</div>
		</div>
	</header>
...
while($row=mysql_fetch_assoc($result))//将result结果集中查询结果取出一条
{
  ...
  echo      " <a href='/service/player.php?action=play&id=".$row["upload_id"]."' target='_blank' title='Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo, eos?'><img src='uploadimg/".$row["pic_name"]."' alt='Free HTML5 Bootstrap template'> </a>";
    echo  "    </div> \n";
   echo "  <div class='fh5co-desc'>主演 :".$row["major_actor"]."  描述 ".$row["describ"]."</div>";
 echo "  </div> \n";
}
?>
